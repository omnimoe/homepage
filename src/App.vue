  ...
  <header>
    <div class="w-full h-14 bg-white shadow-sm backdrop-blur">
      <nav class="flex mx-auto max-w-5xl items-center justify-between px-2 py-2 md:py-0">
        ...
        <span class="inline-flex flex-auto items-stretch rounded-md bg-white px-2 md:flex-none">
          <div class="relative w-full max-w-sm">
            <input type="text" class="block w-full h-10 border-gray-200 rounded-md py-2 pl-2 pr-14 text-xs focus:border-blue-500 focus:ring-blue-500 placeholder:text-gray-500" placeholder="搜索开源项目">
        ...
        <ul class="ml-5 flex items-center space-x-2 font-medium text-gray-500 md:pt-2">
          <li class="hidden md:block hover:font-bold hover:text-gray-800 hover:border-blue-500 hover:border-b-2 h-12 text-gray-500">
            <button type="button" class="inline-flex items-center rounded px-2 py-2 focus:outline-none focus-visible:ring">首页</button>
          </li>
          <li class="hidden md:block hover:font-bold hover:text-gray-800 hover:border-blue-500 hover:border-b-2 h-12 text-gray-500">
            <button type="button" class="inline-flex items-center rounded px-2 py-2 focus:outline-none focus-visible:ring">月刊</button>
          </li>
          <li class="hidden md:block hover:font-bold hover:text-gray-800 hover:border-blue-500 hover:border-b-2 h-12 text-gray-500">
            <button type="button" class="inline-flex items-center rounded px-2 py-2 focus:outline-none focus-visible:ring">🏆榜单</button>
          </li>
          <li class="hidden md:block hover:font-bold hover:text-gray-800 hover:border-blue-500 hover:border-b-2 h-12 text-gray-500">
            <button type="button" class="inline-flex items-center rounded px-2 py-2 focus:outline-none focus-visible:ring">文章</button>
          </li>
          <li class="hidden md:block hover:font-bold hover:text-gray-800 hover:border-blue-500 hover:border-b-2 h-12 text-gray-500">
            <button type="button" class="inline-flex items-center rounded px-2 py-2 focus:outline-none focus-visible:ring">OenFile</button>
          </li>
        </ul>
        <div class="shrink grow"></div>
        <div class="hidden md:flex cursor-pointer space-x-2">
          <div>
            <button type="button" class="flex h-8 items-center rounded-lg border border-blue-500 px-2 bg-blue-500 text-sm text-white">
